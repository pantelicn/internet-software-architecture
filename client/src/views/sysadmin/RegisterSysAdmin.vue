<template>
  <b-container>
    <b-row align-h="center" class="mt-4">
      <h2>
        Register another System Adminstrator
      </h2>
    </b-row>
...
name: "RegisterSysAdmin",
  ...
  methods : {
    register() {
      ...
      .then(() => {
        this.$toast.success("Registration successful. Please check your email to activate your account.");
      })
