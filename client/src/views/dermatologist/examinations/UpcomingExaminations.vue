        ...
        <b-col lg="4" class="my-3 mt-4">
            <b-form-group label="Patient:" label-for="filter-input" label-cols-sm="2" label-align-sm="right"
                ...
                <b-input-group size="sm">
                    ...
                    v-model="filter" type="search" placeholder="Patients name or appointment id..."
                    >
                    </b-form-input>
    ...
    data() {
        return {
            ...
            fields:[
                ...
                { key: 'start', label: 'Appointment begins at', sortable: true },
                { key: 'end', label: 'Appointment ends at', sortable: true },
